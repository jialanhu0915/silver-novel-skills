...
| 系统 | 面向读者 | 题材支持 |
|------|----------|----------|
| 男频 | 男性 | 玄幻、仙侠、都市、悬疑、科幻、游戏、历史、都市异能、穿越、恐怖、宇宙恐怖、DND 奇幻、娱乐圈 |
...
| Agent | 评测维度 |
|-------|----------|
| CosmicHorrorEvaluator | 宇宙恐怖专项（理智机制 / 不可名状 / 爽点与哲学平衡） |
...
│   ├── guide.md          # 男频创作入口
│   ├── agents/
│   │   └── review/       # 男频专项评测 Agents
│   ├── templates/
│   └── prompts/
├── female/               # 女频系统
│   ├── guide.md          # 女频创作入口
│   ├── agents/
│   │   └── review/       # 女频专项评测 Agents
│   ├── templates/
│   └── prompts/
└── shared/               # 共享资源
    ├── agents/
...
```
1. 阅读 male/guide.md
2. 按流程使用 Framework Agents 构建小说框架
3. 使用通用 + 男频专项 Review Agents 进行质量评测
```

**女频创作**

```
1. 阅读 female/guide.md
2. 按流程使用 Framework Agents 构建小说框架
3. 使用通用 + 女频专项 Agents 进行质量评测
```
